...
public class WikipediaParserTest {
	...
	public final void testParseListItem() {
		...
		assertEquals("term", WikipediaParser.parseListItem("; term"));
		
		//ordered lists level 2
		assertEquals("ordered item", WikipediaParser.parseListItem("## ordered item"));
		
		//ordered lists level 4
		assertEquals("ordered item", WikipediaParser.parseListItem("#### ordered item"));
		
		//unordered list level 3
		assertEquals("unordered item", WikipediaParser.parseListItem("*** unordered item"));
		
		//should not alter other formatting
		assertEquals("This is '''bold text''' test", WikipediaParser.parseListItem("This is '''bold text''' test"));
		assertEquals("This is '''bold text''' test", WikipediaParser.parseListItem("This is *'''bold text''' test"));
		assertEquals("This is '''bold text''' test", WikipediaParser.parseListItem("This is '''*bold text''' test"));
		assertEquals("''Pack Up Your Troubles'' (1958) - [[UK Albums Chart]] No.9", WikipediaParser.parseListItem("* ''Pack Up Your Troubles'' (1958) - [[UK Albums Chart]] No.9"));
	...
	public final void testParseTextFormatting() {
		...
		/* TODO: Add more tests */
		//should not alter other formatting
		assertEquals("## ordered item", WikipediaParser.parseTextFormatting("## ordered item"));
		assertEquals("This is *bold text test", WikipediaParser.parseTextFormatting("This is *'''bold text''' test"));
		assertEquals("This is *bold text test", WikipediaParser.parseTextFormatting("This is '''*bold text''' test"));
		assertEquals("* Pack Up Your Troubles (1958) - [[UK Albums Chart]] No.9", WikipediaParser.parseTextFormatting("* ''Pack Up Your Troubles'' (1958) - [[UK Albums Chart]] No.9"));
	}
	...
	public final void testParseLinks() {
		...
		//assertEquals(new Object[]{"public transport", "Public_transport"}, WikipediaParser.parseLinks("[[public transport]]"));
